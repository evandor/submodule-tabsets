<template>
  <div class="q-pa-md q-gutter-sm">
    ...
    <q-banner rounded style="border:1px solid orange">Backup your tabsets to a github repository of your choice.
    </q-banner>
    ...
    <div class="row q-pa-md">
      ...
      <div class="col-3 text-grey-8">Click <a href="https://github.com/settings/tokens" target="_blank">here</a> to create a new
        classic token (use scope <em>public_repo</em>) or a fine-grained token (with <em>content read/write</em> permissions).
      </div>
      <div class="col-1"></div>
      <div class="col-5">
